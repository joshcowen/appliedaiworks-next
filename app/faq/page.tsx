...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Do I need to be tech-savvy to work with you?", "acceptedAnswer": { "@type": "Answer", "text": "Not at all. My clients are business owners and operators, not tech people. I explain everything in plain language, show you exactly how to use each tool, and make sure you're comfortable before we move on. The whole point is that you shouldn't need to become technical to get value from AI." } },
    ...
    { "@type": "Question", "name": "Do you work with businesses outside West Michigan?", "acceptedAnswer": { "@type": "Answer", "text": "My focus is on West Michigan service businesses, but all work is done remotely so geography isn't a barrier. If you're a service business owner outside the area who found this and it resonates, reach out. I take on a limited number of clients at a time and work best with businesses where I can develop real context." } },
    { "@type": "Question", "name": "What exactly is included in the $1,500 AI Audit?", "acceptedAnswer": { "@type": "Answer", "text": "The audit includes a deep-dive interview about your workflows and operations, a written analysis of where AI can save you the most time and money, specific tool recommendations with exact tools and reasoning, a prioritized roadmap with estimated time savings for each item, and a 30-minute debrief call to walk through the findings and answer questions." } },
    { "@type": "Question", "name": "How long does the audit take to complete?", "acceptedAnswer": { "@type": "Answer", "text": "From our kickoff call to final delivery, typically 5-7 business days. The kickoff interview runs about 60-90 minutes. I do the analysis and build the roadmap, then we schedule a debrief. You'll have your full audit document and roadmap within a week of our first call." } },
    ...
    { "@type": "Question", "name": "How is this different from a generic AI consulting engagement?", "acceptedAnswer": { "@type": "Answer", "text": "Most AI consultants come from a software or enterprise background and deliver frameworks and decks. I'm a business operator who has personally used AI to build 80+ projects and save over 5,000 hours of work. I look at your operation the same way I look at mine — practical, specific, no buzzwords. The roadmap you get is designed to be acted on, not filed away." } },
    { "@type": "Question", "name": "Is there a guarantee?", "acceptedAnswer": { "@type": "Answer", "text": "I don't offer a formal refund guarantee because I can't guarantee how quickly you'll act on the roadmap. What I can guarantee is that you'll receive a thorough, specific, and honest deliverable. If you do the discovery call and I don't think there's enough opportunity in your business to justify the audit fee, I'll tell you before you pay." } },
    { "@type": "Question", "name": "Why is the audit $1,500 and not cheaper?", "acceptedAnswer": { "@type": "Answer", "text": "Because it takes real time and requires genuine expertise. The interview, the research into your specific tools and workflows, the written analysis, and the debrief call amount to 8-12 hours of focused work. If the roadmap identifies just 5 hours per week in savings at your team's wage rate, you're looking at payback in 6-10 weeks. That math usually makes it an easy decision." } },
    { "@type": "Question", "name": "What does implementation work cost?", "acceptedAnswer": { "@type": "Answer", "text": "Implementation is priced at $300/hr or as a project rate scoped upfront. For ongoing support and strategy, the Monthly Advisor retainer is $1,500/month and includes two strategy sessions plus async support. Every engagement is scoped before you commit so there are no surprises." } },
    { "@type": "Question", "name": "Can you train my whole team, not just me?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Team training is available and priced per session. We work through real tasks from your business, not generic demos. Each person leaves with hands-on experience using the specific tools relevant to their role, plus written follow-up resources they can reference later." } },
    ...
    { "@type": "Question", "name": "How much of my time does this require?", "acceptedAnswer": { "@type": "Answer", "text": "For the audit: about 90 minutes for the kickoff interview, plus a 30-minute debrief at the end. Everything in between is my work. For implementation engagements, we scope the time commitment upfront. I try to work in focused sprints so I'm not pulling you away from running your business constantly." } },
    ...
    { "@type": "Question", "name": "What tools do you recommend most often for service businesses?", "acceptedAnswer": { "@type": "Answer", "text": "It depends on your operation and what you're already using. For most service businesses, the biggest wins typically come from AI-assisted communication, scheduling and dispatch optimization, and automating the admin work that doesn't need a human touch. The audit is where I figure out the right fit for your specific stack, not a generic checklist." } },
...
export default function FaqPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "https://www.appliedaiworks.com" }, { name: "FAQ", url: "https://www.appliedaiworks.com/faq" }]} />
      <script

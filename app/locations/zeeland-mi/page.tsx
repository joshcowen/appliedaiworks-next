        ...
        <div className="relative max-w-5xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-4xl md:text-5xl font-bold text-on-surface mb-6 leading-tight">
              ...
              <span className="text-kinetic">Zeeland, MI service businesses.</span>
            </h1>
            <p className="text-on-surface-variant text-lg max-w-xl mb-10 leading-relaxed">
              Zeeland&apos;s service trades and small business community are ready for AI — and most competitors haven&apos;t found it yet.
            </p>
      ...
      <section className="py-24 bg-surface-container-lowest">
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="font-headline text-2xl font-bold text-on-surface mb-4">Zeeland businesses have a first-mover advantage right now.</h2>
              <p className="text-on-surface-variant leading-relaxed mb-4">
                AI adoption in small service businesses is still early. Most of your competitors aren&apos;t using it yet — which means the ones who figure it out first will have a real edge in efficiency, response time, and capacity.
              </p>
              <p className="text-on-surface-variant leading-relaxed mb-4">
                The businesses that move now won&apos;t be playing catch-up in two years. The audit gives you a clear picture of where to start and what it&apos;s worth.
              </p>
            </div>
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="font-headline text-3xl font-bold text-on-surface mb-4">Industries served in Zeeland, MI</h2>
          </div>

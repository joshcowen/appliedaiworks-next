...
export const metadata: Metadata = {
  title: "AI Consulting for Holland, MI — Service Businesses",
  description:
...
export default function HollandMiPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "https://www.appliedaiworks.com" }, { name: "Locations", url: "https://www.appliedaiworks.com/locations/holland-mi" }, { name: "Holland, MI", url: "https://www.appliedaiworks.com/locations/holland-mi" }]} />
      {/* Hero */}
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed mb-4">
                I&apos;m a Holland business owner who built 80+ AI tools and logged 5,000+ hours figuring out what works. Not a consultant from Grand Rapids who added &quot;AI&quot; to their website. I live in the community I serve.
              </p>

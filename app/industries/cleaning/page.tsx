...
export default function CleaningPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "https://www.appliedaiworks.com" }, { name: "Industries", url: "https://www.appliedaiworks.com/industries/cleaning" }, { name: "Cleaning", url: "https://www.appliedaiworks.com/industries/cleaning" }]} />
      {/* Hero */}

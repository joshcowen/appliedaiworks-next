...
export const metadata: Metadata = {
  title: "AI Consulting for Construction Companies — Applied AI Works",
  description:
...
export default function ConstructionPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "https://www.appliedaiworks.com" }, { name: "Industries", url: "https://www.appliedaiworks.com/industries/construction" }, { name: "Construction", url: "https://www.appliedaiworks.com/industries/construction" }]} />
      {/* Hero */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed mb-4">
                I&apos;m not an enterprise consultant parachuted in from a software background. I&apos;m a business operator who built 80+ AI projects and logged 5,000+ hours figuring out what works for companies running tight schedules and real crews.
              </p>
      ...
      <RelatedPosts
        topic="construction"
        subhead="Practical write-ups on what actually works for construction operations."
      />

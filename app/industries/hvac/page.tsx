...
export default function HvacPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "https://www.appliedaiworks.com" }, { name: "Industries", url: "https://www.appliedaiworks.com/industries/hvac" }, { name: "HVAC", url: "https://www.appliedaiworks.com/industries/hvac" }]} />
      {/* Hero */}
      ...
      <RelatedPosts
        topic="hvac"
        subhead="Practical write-ups on what actually works for HVAC operations."
      />

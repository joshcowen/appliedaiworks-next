...
export default function PlumbingPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "https://www.appliedaiworks.com" }, { name: "Industries", url: "https://www.appliedaiworks.com/industries/plumbing" }, { name: "Plumbing", url: "https://www.appliedaiworks.com/industries/plumbing" }]} />
      {/* Hero */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed mb-6">
                Every recommendation is based on 5,000+ hours of hands-on work, not a vendor playbook.
              </p>
